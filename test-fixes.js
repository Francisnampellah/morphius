...
// Test the fixes by creating a .bin file and .txt files
...
async function testFixes() {
  ...
  // Create .txt files (these should be processed even if they don't match the .bin prefix exactly)
  ...
  console.log('✅ Created .txt files: as_000001.txt, as_000002.txt, as_000003.txt');
  
  console.log('\n📁 Test files created in ~/Documents/input/');
  console.log('   Expected result: 000025_18_result.txt in ~/Documents/results/');
  console.log('   (Using .bin prefix for naming, processing all .txt files)');
